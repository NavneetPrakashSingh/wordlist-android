 ...
 */
public class CustomAdapter_q extends ArrayAdapter<q_main.SimpleList>{


    CustomAdapter_q(Context context, q_main.SimpleList[] simpleLists) {
        super(context,R.layout.q_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.q_custom_row,parent,false);
