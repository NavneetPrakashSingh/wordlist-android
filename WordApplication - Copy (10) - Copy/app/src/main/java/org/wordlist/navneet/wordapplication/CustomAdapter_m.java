 ...
 */
public class CustomAdapter_m extends ArrayAdapter<m_main.SimpleList>{


    CustomAdapter_m(Context context, m_main.SimpleList[] simpleLists) {
        super(context,R.layout.m_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.m_custom_row,parent,false);
