 ...
 */
public class CustomAdapter_c extends ArrayAdapter<c_main.SimpleList>{


    CustomAdapter_c(Context context, c_main.SimpleList[] simpleLists) {
        super(context,R.layout.c_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.c_custom_row,parent,false);
