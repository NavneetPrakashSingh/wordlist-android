 ...
 */
public class CustomAdapter_x extends ArrayAdapter<x_main.SimpleList>{


    CustomAdapter_x(Context context, x_main.SimpleList[] simpleLists) {
        super(context,R.layout.x_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.x_custom_row,parent,false);
