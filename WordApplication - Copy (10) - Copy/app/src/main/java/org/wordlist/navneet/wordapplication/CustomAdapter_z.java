 ...
 */
public class CustomAdapter_z extends ArrayAdapter<z_main.SimpleList>{


    CustomAdapter_z(Context context, z_main.SimpleList[] simpleLists) {
        super(context,R.layout.z_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.z_custom_row,parent,false);
