 ...
 */
public class CustomAdapter_u extends ArrayAdapter<u_main.SimpleList>{


    CustomAdapter_u(Context context, u_main.SimpleList[] simpleLists) {
        super(context,R.layout.u_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.u_custom_row,parent,false);
