 ...
 */
public class CustomAdapter_f extends ArrayAdapter<f_main.SimpleList>{


    CustomAdapter_f(Context context, f_main.SimpleList[] simpleLists) {
        super(context,R.layout.f_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.f_custom_row,parent,false);
