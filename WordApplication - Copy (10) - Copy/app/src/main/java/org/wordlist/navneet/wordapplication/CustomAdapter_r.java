 ...
 */
public class CustomAdapter_r extends ArrayAdapter<r_main.SimpleList>{


    CustomAdapter_r(Context context, r_main.SimpleList[] simpleLists) {
        super(context,R.layout.r_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.r_custom_row,parent,false);
