...
public class DatabaseHelper3 extends SQLiteOpenHelper {
    // this table is for favorite list
    // Database Name
    public static String DATABASE_NAME = "student_database3";

    // Current version of database
    private static final int DATABASE_VERSION = 2;

    // Name of table
    private static final String TABLE_STUDENTS = "students3";
    ...
    public long addStudentDetail(StudentsModel3 student) {
     ...
     * @return
     */
    public int updateEntry(StudentsModel3 student) {
        SQLiteDatabase db = this.getWritableDatabase();
...
//            db.execSQL(selectQuery);
    ...
    public StudentsModel3 getStudent(long id) {
        ...
        StudentsModel3 students = new StudentsModel3();
     ...
     * @return
     */
    public List<StudentsModel3> getAllStudentsList() {
        List<StudentsModel3> studentsArrayList = new ArrayList<StudentsModel3>();
    ...
    public List<StudentsModel3> getAllStudentsLista(String str1) {
        List<StudentsModel3> studentsArrayList = new ArrayList<StudentsModel3>();

        String selectQuery = "SELECT  * FROM " + TABLE_STUDENTS +" WHERE name LIKE '"+str1+"%'";
        Log.d(TAG, selectQuery);
