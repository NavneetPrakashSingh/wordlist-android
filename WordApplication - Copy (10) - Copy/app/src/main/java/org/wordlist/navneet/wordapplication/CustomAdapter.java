 ...
 */
public class CustomAdapter extends ArrayAdapter<a_main.SimpleList>{


    CustomAdapter(Context context, a_main.SimpleList[] simpleLists) {
        super(context,R.layout.a_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.a_custom_row,parent,false);
