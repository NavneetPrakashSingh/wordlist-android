 ...
 */
public class CustomAdapter_n extends ArrayAdapter<n_main.SimpleList>{


    CustomAdapter_n(Context context, n_main.SimpleList[] simpleLists) {
        super(context,R.layout.n_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.n_custom_row,parent,false);
