 ...
 */
public class CustomAdapter_s extends ArrayAdapter<s_main.SimpleList>{


    CustomAdapter_s(Context context, s_main.SimpleList[] simpleLists) {
        super(context,R.layout.s_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.s_custom_row,parent,false);
