 ...
 */
public class CustomAdapter_g extends ArrayAdapter<g_main.SimpleList>{


    CustomAdapter_g(Context context, g_main.SimpleList[] simpleLists) {
        super(context,R.layout.g_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.g_custom_row,parent,false);
