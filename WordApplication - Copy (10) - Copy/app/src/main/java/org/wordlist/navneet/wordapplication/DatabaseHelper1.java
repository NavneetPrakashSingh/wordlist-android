...
/**
 * Created by Navneet on 7/20/2015.
 */
...
public class DatabaseHelper1 extends SQLiteOpenHelper{
    ...
    // Database Name
    public static String DATABASE_NAME = "student_database1";

    // Current version of database
    private static final int DATABASE_VERSION = 2;

    // Name of table
    private static final String TABLE_STUDENTS = "students1";
    ...
    public long addStudentDetail(StudentsModel1 student) {
     ...
     * @return
     */
    public int updateEntry(StudentsModel1 student) {
        SQLiteDatabase db = this.getWritableDatabase();
...
//            db.execSQL(selectQuery);
    ...
    public StudentsModel1 getStudent(long id) {
        ...
        StudentsModel1 students = new StudentsModel1();
     ...
     * @return
     */
    public List<StudentsModel1> getAllStudentsList() {
        List<StudentsModel1> studentsArrayList = new ArrayList<StudentsModel1>();
