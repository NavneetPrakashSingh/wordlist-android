 ...
 */
public class CustomAdapter_w extends ArrayAdapter<w_main.SimpleList>{


    CustomAdapter_w(Context context, w_main.SimpleList[] simpleLists) {
        super(context,R.layout.w_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.w_custom_row,parent,false);
