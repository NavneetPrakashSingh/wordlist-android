 ...
 */
public class CustomAdapter_b extends ArrayAdapter<b_main.SimpleList>{


    CustomAdapter_b(Context context, b_main.SimpleList[] simpleLists) {
        super(context, R.layout.b_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.b_custom_row,parent,false);
