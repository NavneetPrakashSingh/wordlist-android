 ...
 */
public class CustomAdapter_d extends ArrayAdapter<d_main.SimpleList>{


    CustomAdapter_d(Context context, d_main.SimpleList[] simpleLists) {
        super(context,R.layout.d_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.d_custom_row,parent,false);
