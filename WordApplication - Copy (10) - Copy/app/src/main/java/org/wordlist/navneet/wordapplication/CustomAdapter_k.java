 ...
 */
public class CustomAdapter_k extends ArrayAdapter<k_main.SimpleList>{


    CustomAdapter_k(Context context, k_main.SimpleList[] simpleLists) {
        super(context,R.layout.k_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.k_custom_row,parent,false);
