 ...
 */
public class CustomAdapter_i extends ArrayAdapter<i_main.SimpleList>{


    CustomAdapter_i(Context context, i_main.SimpleList[] simpleLists) {
        super(context, R.layout.i_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.i_custom_row,parent,false);
