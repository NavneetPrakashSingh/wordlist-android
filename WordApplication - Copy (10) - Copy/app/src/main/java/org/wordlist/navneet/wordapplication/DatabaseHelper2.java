...
public class DatabaseHelper2 extends SQLiteOpenHelper {
    ...
    // Database Name
    public static String DATABASE_NAME = "student_database2";

    // Current version of database
    private static final int DATABASE_VERSION = 2;

    // Name of table
    private static final String TABLE_STUDENTS = "students2";
    ...
    public long addStudentDetail(StudentsModel2 student) {
     ...
     * @return
     */
    public int updateEntry(StudentsModel2 student) {
        SQLiteDatabase db = this.getWritableDatabase();
...
//            db.execSQL(selectQuery);
    ...
    public StudentsModel2 getStudent(long id) {
        ...
        StudentsModel2 students = new StudentsModel2();
     ...
     * @return
     */
    public List<StudentsModel2> getAllStudentsList() {
        List<StudentsModel2> studentsArrayList = new ArrayList<StudentsModel2>();
    ...
    public List<StudentsModel2> getAllStudentsLista(String str1) {
        List<StudentsModel2> studentsArrayList = new ArrayList<StudentsModel2>();
