 ...
 */
public class CustomAdapter_p extends ArrayAdapter<p_main.SimpleList>{


    CustomAdapter_p(Context context, p_main.SimpleList[] simpleLists) {
        super(context, R.layout.p_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.p_custom_row,parent,false);
