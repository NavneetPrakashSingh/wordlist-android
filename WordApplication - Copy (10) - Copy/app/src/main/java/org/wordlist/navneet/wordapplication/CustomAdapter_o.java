 ...
 */
public class CustomAdapter_o extends ArrayAdapter<o_main.SimpleList>{


    CustomAdapter_o(Context context, o_main.SimpleList[] simpleLists) {
        super(context,R.layout.o_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.o_custom_row,parent,false);
