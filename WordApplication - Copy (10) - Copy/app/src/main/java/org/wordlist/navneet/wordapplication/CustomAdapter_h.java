 ...
 */
public class CustomAdapter_h extends ArrayAdapter<h_main.SimpleList>{


    CustomAdapter_h(Context context, h_main.SimpleList[] simpleLists) {
        super(context,R.layout.h_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.h_custom_row,parent,false);
