 ...
 */
public class CustomAdapter_j extends ArrayAdapter<j_main.SimpleList>{


    CustomAdapter_j(Context context, j_main.SimpleList[] simpleLists) {
        super(context,R.layout.j_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.j_custom_row,parent,false);
