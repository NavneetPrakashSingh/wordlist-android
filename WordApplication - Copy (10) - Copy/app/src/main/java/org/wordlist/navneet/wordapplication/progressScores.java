...
public class progressScores extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            Button homePage=(Button) findViewById(R.id.mainscreen);
            homePage.setOnClickListener(new View.OnClickListener(){
                @Override
                public void onClick(View arg0) {
                    Intent in=new Intent();
                    in.setClass(progressScores.this,MainActivity.class);
                    startActivity(in);
                }
        ...
        try {
            ...
            switchButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    intent.setClass(progressScores.this, totalScore.class);
...
//            }
           ...
           if(list.size()==0){
               ...
               new AlertDialog.Builder(this).setTitle("Word List").setMessage("Looks like you haven't taken any quiz yet, please do take and come back here to mark your progress")
                       .setPositiveButton("OK", new DialogInterface.OnClickListener() {

                           public void onClick(DialogInterface arg0, int arg1) {
                               // Some stuff to do when ok got clicked
                               Intent in=new Intent(progressScores.this,MainActivity.class);
                               startActivity(in);
        ...
        if (mChartView == null) {
            ...
            mChartView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (seriesSelection == null) {
                        Toast.makeText(progressScores.this,"No chart element was clicked",Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(progressScores.this,"Chart element data point index "+ (seriesSelection.getPointIndex()+1) + " was clicked" + " point value="+ seriesSelection.getValue(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
            ...
            mChartView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    SeriesSelection seriesSelection = mChartView.getCurrentSeriesAndPoint();
                    if (seriesSelection == null) {
                        Toast.makeText(progressScores.this,"No chart element was long pressed", Toast.LENGTH_SHORT);
                        return false;
                    } else {
                        Toast.makeText(progressScores.this,"Chart element data point index "+ seriesSelection.getPointIndex()+ " was long pressed",Toast.LENGTH_SHORT);
                        return true;
                    }
                }
            });
