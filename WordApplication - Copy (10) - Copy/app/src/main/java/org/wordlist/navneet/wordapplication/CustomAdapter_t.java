 ...
 */
public class CustomAdapter_t extends ArrayAdapter<t_main.SimpleList>{


    CustomAdapter_t(Context context, t_main.SimpleList[] simpleLists) {
        super(context,R.layout.t_custom_row, simpleLists);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView=firstInflater.inflate(R.layout.t_custom_row,parent,false);
